...
public class mesesServicios {
    Meses m1 = new Meses();
    public void mesSecreto(Meses sm) {
		Scanner leer = new Scanner(System.in);
		
		System.out.print("Adivina el mes secreto: ");
		while (!leer.nextLine().equalsIgnoreCase(sm.getMesSecreto())) {
			System.out.print("Incorrecto! Intenta nuevamente: ");
		}
		System.out.println("Adivinaste! El mes secreto era " + sm.getMesSecreto().toUpperCase() + "!");
	}
}
